...
enum pio_pin {
  P0_0, P0_1, P0_2, P0_3, P0_4, P0_5, P0_6, P0_7, P0_8, P0_9, P0_10, P0_11, P1_0, P1_1, P1_2, P1_3, P1_4, P1_5, P1_6, P1_7, P1_8, P1_9, P1_10, P1_11, P2_0, P2_1, P2_2, P2_3, P2_4, P2_4, P2_5, P2_5, P2_6, P2_7, P2_8, P2_9, P2_10, P2_11, P3_0, P3_1, P3_2, P3_3, P3_4, P3_5
};
...
void pin_setup (enum pio_pin pin, enum io_function func, enum io_mode mode, int hyst)
{
  ...
  switch (pin) {
    ...
    case P2_1:
      ...
      LPC_IOCON->PIO2_1 = (LPC_IOCON->PIO2_1 & ~mask) | f | other;
      break;
    case P2_2:
      switch (func) {
        case PIO: f = 0; break;
      ...
      LPC_IOCON->PIO2_2 = (LPC_IOCON->PIO2_2 & ~mask) | f | other;
      break;
    case P2_3:
      switch (func) {
        case PIO: f = 0; break;
      ...
      LPC_IOCON->PIO2_3 = (LPC_IOCON->PIO2_3 & ~mask) | f | other;
      break;
    case P2_11:
      switch (func) {
        case PIO: f = 0; break;
      ...
      LPC_IOCON->PIO2_11 = (LPC_IOCON->PIO2_11 & ~mask) | f | other;
      break;
    default:
