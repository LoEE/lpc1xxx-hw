  ...
  switch (pin) {
    ...
    case P2_0:
      switch (func) {
        ...
        case nRTS0: f = 4; other |= 1 << 7; break;
        default:
    ...
    case P2_3:
      switch (func) {
        ...
        case nDTR0: f = 4; other |= 1 << 7; break;
        default:
    ...
    case P2_4:
      switch (func) {
        ...
        case nCTS0: f = 4; other |= 1 << 7; break;
        default:
    ...
    case P2_6:
      switch (func) {
        ...
        case nDCD0: f = 4; other |= 1 << 7; break;
        default:
    ...
    case P2_7:
      switch (func) {
        ...
        case nDSR0: f = 4; other |= 1 << 7; break;
        default:
