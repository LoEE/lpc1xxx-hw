/*
   IO functions for NXP LPC151x devices in LQFP100 package.
...
void pin_setup (enum pio_pin pin, enum io_function func, enum io_mode mode)
{
  ...
  switch (pin) {
    ...
    case P1_11:
      ...
      break;
    case P1_12:
      if (func != PIO) ERROR("PIO1_12 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_12 = f | other;
      break;
    case P1_13:
      if (func != PIO) ERROR("PIO1_13 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_13 = f | other;
      break;
    case P1_14:
      switch (func) {
        case PIO: f = 0; break;
        case SCT0_OUT7: f = 1; break;
        default:
          ERROR("PIO1_14 can only be used as SCT0_OUT7 or PIO.");
      }
      LPC_IOCON->PIO1_14 = f | other;
      break;
    case P1_15:
      if (func != PIO) ERROR("PIO1_15 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_15 = f | other;
      break;
    case P1_16:
      if (func != PIO) ERROR("PIO1_16 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_16 = f | other;
      break;
    case P1_17:
      switch (func) {
        case PIO: f = 0; break;
        case SCT1_OUT7: f = 1; break;
        default:
          ERROR("PIO1_17 can only be used as SCT1_OUT7 or PIO.");
      }
      LPC_IOCON->PIO1_17 = f | other;
      break;
    case P1_18:
      if (func != PIO) ERROR("PIO1_18 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_18 = f | other;
      break;
    case P1_19:
      if (func != PIO) ERROR("PIO1_19 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_19 = f | other;
      break;
    case P1_20:
      switch (func) {
        case PIO: f = 0; break;
        case SCT2_OUT5: f = 1; break;
        default:
          ERROR("PIO1_20 can only be used as SCT2_OUT5 or PIO.");
      }
      LPC_IOCON->PIO1_20 = f | other;
      break;
    case P1_21:
      if (func != PIO) ERROR("PIO1_21 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_21 = f | other;
      break;
    case P1_22:
      if (func != PIO) ERROR("PIO1_22 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_22 = f | other;
      break;
    case P1_23:
      if (func != PIO) ERROR("PIO1_23 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_23 = f | other;
      break;
    case P1_24:
      switch (func) {
        case PIO: f = 0; break;
        case SCT3_OUT5: f = 1; break;
        default:
          ERROR("PIO1_24 can only be used as SCT3_OUT5 or PIO.");
      }
      LPC_IOCON->PIO1_24 = f | other;
      break;
    case P1_25:
      if (func != PIO) ERROR("PIO1_25 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_25 = f | other;
      break;
    case P1_26:
      if (func != PIO) ERROR("PIO1_26 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_26 = f | other;
      break;
    case P1_27:
      if (func != PIO) ERROR("PIO1_27 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_27 = f | other;
      break;
    case P1_28:
      if (func != PIO) ERROR("PIO1_28 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_28 = f | other;
      break;
    case P1_29:
      if (func != PIO) ERROR("PIO1_29 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_29 = f | other;
      break;
    case P1_30:
      if (func != PIO) ERROR("PIO1_30 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_30 = f | other;
      break;
    case P1_31:
      if (func != PIO) ERROR("PIO1_31 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO1_31 = f | other;
      break;
    case P2_0:
      if (func != PIO) ERROR("PIO2_0 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO2_0 = f | other;
      break;
    case P2_1:
      if (func != PIO) ERROR("PIO2_1 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO2_1 = f | other;
      break;
    case P2_2:
      if (func != PIO) ERROR("PIO2_2 can only be used as PIO.");
      f = 0;
      LPC_IOCON->PIO2_2 = f | other;
      break;
    case P2_3:
      if (func != PIO) ERROR("PIO2_3 can only be used as PIO.");
      f = 0;
    ...
    case P2_10:
      ...
      break;
    case P2_11:
      if (func != PIO) ERROR("PIO2_11 can only be used as PIO.");
      f = 0;
...
void pin_write (enum pio_pin pin, int val)
{
  switch (pin) {
    ...
    case P1_12: LPC_GPIO_PORT->B[P1_12] = val ? 1 : 0; break;
    case P1_13: LPC_GPIO_PORT->B[P1_13] = val ? 1 : 0; break;
    case P1_14: LPC_GPIO_PORT->B[P1_14] = val ? 1 : 0; break;
    case P1_15: LPC_GPIO_PORT->B[P1_15] = val ? 1 : 0; break;
    case P1_16: LPC_GPIO_PORT->B[P1_16] = val ? 1 : 0; break;
    case P1_17: LPC_GPIO_PORT->B[P1_17] = val ? 1 : 0; break;
    case P1_18: LPC_GPIO_PORT->B[P1_18] = val ? 1 : 0; break;
    case P1_19: LPC_GPIO_PORT->B[P1_19] = val ? 1 : 0; break;
    case P1_20: LPC_GPIO_PORT->B[P1_20] = val ? 1 : 0; break;
    case P1_21: LPC_GPIO_PORT->B[P1_21] = val ? 1 : 0; break;
    case P1_22: LPC_GPIO_PORT->B[P1_22] = val ? 1 : 0; break;
    case P1_23: LPC_GPIO_PORT->B[P1_23] = val ? 1 : 0; break;
    case P1_24: LPC_GPIO_PORT->B[P1_24] = val ? 1 : 0; break;
    case P1_25: LPC_GPIO_PORT->B[P1_25] = val ? 1 : 0; break;
    case P1_26: LPC_GPIO_PORT->B[P1_26] = val ? 1 : 0; break;
    case P1_27: LPC_GPIO_PORT->B[P1_27] = val ? 1 : 0; break;
    case P1_28: LPC_GPIO_PORT->B[P1_28] = val ? 1 : 0; break;
    case P1_29: LPC_GPIO_PORT->B[P1_29] = val ? 1 : 0; break;
    case P1_30: LPC_GPIO_PORT->B[P1_30] = val ? 1 : 0; break;
    case P1_31: LPC_GPIO_PORT->B[P1_31] = val ? 1 : 0; break;
    case P2_0: LPC_GPIO_PORT->B[P2_0] = val ? 1 : 0; break;
    case P2_1: LPC_GPIO_PORT->B[P2_1] = val ? 1 : 0; break;
    case P2_2: LPC_GPIO_PORT->B[P2_2] = val ? 1 : 0; break;
    case P2_3: LPC_GPIO_PORT->B[P2_3] = val ? 1 : 0; break;
    case P2_4: LPC_GPIO_PORT->B[P2_4] = val ? 1 : 0; break;
    case P2_5: LPC_GPIO_PORT->B[P2_5] = val ? 1 : 0; break;
    case P2_6: LPC_GPIO_PORT->B[P2_6] = val ? 1 : 0; break;
    case P2_7: LPC_GPIO_PORT->B[P2_7] = val ? 1 : 0; break;
    case P2_8: LPC_GPIO_PORT->B[P2_8] = val ? 1 : 0; break;
    case P2_9: LPC_GPIO_PORT->B[P2_9] = val ? 1 : 0; break;
    case P2_10: LPC_GPIO_PORT->B[P2_10] = val ? 1 : 0; break;
    case P2_11: LPC_GPIO_PORT->B[P2_11] = val ? 1 : 0; break;
...
int pin_read (enum pio_pin pin)
{
  switch (pin) {
    ...
    case P1_12: return LPC_GPIO_PORT->B[P1_12];
    case P1_13: return LPC_GPIO_PORT->B[P1_13];
    case P1_14: return LPC_GPIO_PORT->B[P1_14];
    case P1_15: return LPC_GPIO_PORT->B[P1_15];
    case P1_16: return LPC_GPIO_PORT->B[P1_16];
    case P1_17: return LPC_GPIO_PORT->B[P1_17];
    case P1_18: return LPC_GPIO_PORT->B[P1_18];
    case P1_19: return LPC_GPIO_PORT->B[P1_19];
    case P1_20: return LPC_GPIO_PORT->B[P1_20];
    case P1_21: return LPC_GPIO_PORT->B[P1_21];
    case P1_22: return LPC_GPIO_PORT->B[P1_22];
    case P1_23: return LPC_GPIO_PORT->B[P1_23];
    case P1_24: return LPC_GPIO_PORT->B[P1_24];
    case P1_25: return LPC_GPIO_PORT->B[P1_25];
    case P1_26: return LPC_GPIO_PORT->B[P1_26];
    case P1_27: return LPC_GPIO_PORT->B[P1_27];
    case P1_28: return LPC_GPIO_PORT->B[P1_28];
    case P1_29: return LPC_GPIO_PORT->B[P1_29];
    case P1_30: return LPC_GPIO_PORT->B[P1_30];
    case P1_31: return LPC_GPIO_PORT->B[P1_31];
    case P2_0: return LPC_GPIO_PORT->B[P2_0];
    case P2_1: return LPC_GPIO_PORT->B[P2_1];
    case P2_2: return LPC_GPIO_PORT->B[P2_2];
    case P2_3: return LPC_GPIO_PORT->B[P2_3];
    case P2_4: return LPC_GPIO_PORT->B[P2_4];
    case P2_5: return LPC_GPIO_PORT->B[P2_5];
    case P2_6: return LPC_GPIO_PORT->B[P2_6];
    case P2_7: return LPC_GPIO_PORT->B[P2_7];
    case P2_8: return LPC_GPIO_PORT->B[P2_8];
    case P2_9: return LPC_GPIO_PORT->B[P2_9];
    case P2_10: return LPC_GPIO_PORT->B[P2_10];
    case P2_11: return LPC_GPIO_PORT->B[P2_11];
...
void pin_dir (enum pio_pin pin, enum pin_dir dir)
{
  switch (pin) {
    ...
    case P1_12: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 12)) | (dir ? 1 << 12 : 0); break;
    case P1_13: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 13)) | (dir ? 1 << 13 : 0); break;
    case P1_14: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 14)) | (dir ? 1 << 14 : 0); break;
    case P1_15: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 15)) | (dir ? 1 << 15 : 0); break;
    case P1_16: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 16)) | (dir ? 1 << 16 : 0); break;
    case P1_17: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 17)) | (dir ? 1 << 17 : 0); break;
    case P1_18: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 18)) | (dir ? 1 << 18 : 0); break;
    case P1_19: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 19)) | (dir ? 1 << 19 : 0); break;
    case P1_20: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 20)) | (dir ? 1 << 20 : 0); break;
    case P1_21: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 21)) | (dir ? 1 << 21 : 0); break;
    case P1_22: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 22)) | (dir ? 1 << 22 : 0); break;
    case P1_23: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 23)) | (dir ? 1 << 23 : 0); break;
    case P1_24: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 24)) | (dir ? 1 << 24 : 0); break;
    case P1_25: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 25)) | (dir ? 1 << 25 : 0); break;
    case P1_26: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 26)) | (dir ? 1 << 26 : 0); break;
    case P1_27: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 27)) | (dir ? 1 << 27 : 0); break;
    case P1_28: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 28)) | (dir ? 1 << 28 : 0); break;
    case P1_29: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 29)) | (dir ? 1 << 29 : 0); break;
    case P1_30: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 30)) | (dir ? 1 << 30 : 0); break;
    case P1_31: LPC_GPIO_PORT->DIR[1] = (LPC_GPIO_PORT->DIR[1] & ~(1 << 31)) | (dir ? 1 << 31 : 0); break;
    case P2_0: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 0)) | (dir ? 1 << 0 : 0); break;
    case P2_1: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 1)) | (dir ? 1 << 1 : 0); break;
    case P2_2: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 2)) | (dir ? 1 << 2 : 0); break;
    case P2_3: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 3)) | (dir ? 1 << 3 : 0); break;
    case P2_4: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 4)) | (dir ? 1 << 4 : 0); break;
    case P2_5: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 5)) | (dir ? 1 << 5 : 0); break;
    case P2_6: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 6)) | (dir ? 1 << 6 : 0); break;
    case P2_7: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 7)) | (dir ? 1 << 7 : 0); break;
    case P2_8: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 8)) | (dir ? 1 << 8 : 0); break;
    case P2_9: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 9)) | (dir ? 1 << 9 : 0); break;
    case P2_10: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 10)) | (dir ? 1 << 10 : 0); break;
    case P2_11: LPC_GPIO_PORT->DIR[2] = (LPC_GPIO_PORT->DIR[2] & ~(1 << 11)) | (dir ? 1 << 11 : 0); break;
